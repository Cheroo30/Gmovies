...
const ImageMovie = () => {
  ...
  const paginatedItems = popularMovies.slice(
  ...
  const bannerImage =
    popularMovies.length > 0 ? popularMovies[0].backdrop_path : null;
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-4 md:p-8 flex-grow">
          <div className="flex-grow">
            <CategorySection title="Popular Movies" items={paginatedItems} />
          </div>
          {totalPages > 1 && (
            <Pagination
